        ...
        <el-row type="flex" class="row_active">
            <el-col :span="24">
                <el-table :data="tableData" border style="width: 100%">
                    ...
                    <el-table-column prop="is_activated" label="设备激状态" :formatter="formatterType" width="120"></el-table-column>
    ...
    <el-dialog :visible.sync="dialogVisible1" width="40%" :before-close="handleClose">
      ...
      {validator: jiousername, trigger: 'blur' }
                ...
                <el-form-item label="设备型号：" style="display: flex;">
                    <el-select v-model="ruleForm2.dev_typess" placeholder="请选择" @change="onChange2" style="width:200px;">
                ...
                <el-form-item prop="nickname">
                    <el-form-item label="总容量:">
                        <el-input v-model="ruleForm2.total_capss" placeholder="请输入总容量"></el-input>
                    </el-form-item>
                </el-form-item>
    ...
    methods: {
        ...
        importDevice() {
           ...
           // this.ruleForm2.dev_type = this.ruleForm2.dev_type === "RK3328" ? 1 : 2;
            this.ruleForm2.total_cap = Number(this.ruleForm2.total_capss.replace("G",""));
