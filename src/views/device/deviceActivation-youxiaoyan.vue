<template>
  <section class="myself-container device_active">
        ...
        <div v-show="showState">
          <el-row type="flex" class="row_activess">
            <el-form-item label="设备激活：" style="display: flex;">
              <el-select v-model="is_activated" placeholder="请选择" style="width:150px;">
                <el-option
      ...
      <el-row type="flex" class="row_active">
        <el-col :span="24">
          <el-table :data="tableData" border style="width: 100%">
            ...
            <el-table-column prop="cpu_id" label="CPU-ID" width="100"></el-table-column>
            <el-table-column prop="total_cap" label="总容量" :formatter="formatDevCap" width="120"></el-table-column>
            <el-table-column prop="import_ts" width="170" label="新建时间" sortable :formatter="formatterImport"></el-table-column>
            <el-table-column
              prop="is_activated"
              label="设备激活"
              ...
              width="120"
            ></el-table-column>
            <el-table-column prop="activate_ts" label="激活时间" width="170" sortable :formatter="formatterActive"></el-table-column>
    ...
    <!-- <el-dialog :visible.sync="dialogVisible111" width="40%" :before-close="handleClose">
      <div class="addaccout">
        <el-form
          :model="ruleForm2"
          :rules="rules2"
        ...
        >
          ...
          <el-form-item prop="nickname">
            <el-form-item label="MAC地址:">
              <el-input v-model="ruleForm2.dev_mac" placeholder="请输入MAC地址1"></el-input>
            </el-form-item>
          </el-form-item>
          <el-form-item prop="nickname">
      ...
      >
        ...
        <el-form-item label="ROM：" >
          ...
          <el-form-item label="MAC地址:" prop="dev_mac" >
           ...
           <el-form-item label="总容量:" prop="total_cap">
              <el-input v-model="ruleForm2.total_cap" placeholder="请输入总容量" style="width:300px;"></el-input>
          </el-form-item>
      </el-form>
      <el-button type="primary" @click="importDevice('ruleForm2')">确 定</el-button>
      </div>
    </el-dialog>
