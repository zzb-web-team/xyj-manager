                    ...
                    <div class="add-sdk">
                        <div class="item">
                            ...
                            <div class="item-r" style="position: relative;">
                                ...
                                <el-button type="primary" class="onchoose-file" @click="upFile1()" :disabled="disableStatus">确定</el-button>
                                进度条 <span id="per1">0</span>%
                                <div style="width: 400px;height: 16px;background-color: #999;margin-top:10px;">
                                    <div style="width: 0%;height: 16px;background-color: #67c23a" id="loading1"></div>
                                </div>
                ...
                <div class="dialog_div_upload">
                    ...
                    <div class="add-sdk">
                        <div class="item">
                            ...
                            <div class="item-r" style="position: relative;">
                                <el-button class="choose-file" size="mini">请选择要上传的文件</el-button>
                                <input id="f2" class="choose-input" type="file" name="file">
                                <el-button type="primary" class="onchoose-file" @click="upFile2()" :disabled="disableStatus">确定</el-button>
                                进度条 <span id="per2">0</span>%
                                <div style="width: 400px;height: 16px;background-color: #999;margin-top:10px;">
                                    <div style="width: 0%;height: 16px;background-color: #67c23a" id="loading2"></div>
                                </div>
                    ...
                    if (xhr.readyState == 4) {
                        ...
                        if (xhr.status == 200) {
                            ...
                            if (headers.status == 0) {
                                ...
                                _this.newObject1.rom_url = headers.url
                                _this.newObject1.rom_size = headers.size
                                _this.newObject1.md5 = headers.md5
                                _this.newObject1.push_mod = _this.pushType
                                _this.newObject1.hashid = headers.hashid
                    ...
                    if (xhr.readyState == 4) {
                        ...
                        if (xhr.status == 200) {
                            ...
                            if (headers.status == 0) {
                                ...
                                document.getElementById("loading1").style.width = Math.floor(index / tota_temp * 100) + "%";
                                document.getElementById('per1').innerHTML = Math.floor(index / tota_temp * 100)
                                sliceandpost();

                            } else if (headers.status == 1) {
                                document.getElementById('result1').innerHTML = "上传成功:" + headers.msg
                                _this.sdkUrl = headers.url
                                _this.disableStatus = false
                    ...
                    if (xhr.readyState == 4) {
                        ...
                        if (xhr.status == 200) {
                            ...
                            if (headers.status == 0) {
                                ...
                                document.getElementById("loading2").style.width = Math.floor(index / tota_temp * 100) + "%";
                                document.getElementById('per2').innerHTML = Math.floor(index / tota_temp * 100)
                                sliceandpost();

                            } else if (headers.status == 1) {
                                document.getElementById('result2').innerHTML = "上传成功:" + headers.msg
                                _this.sdkUrl = headers.url
                                _this.disableStatus = false
                                ...
                                _this.newObject3.rom_url = headers.url
                                _this.newObject3.rom_size = headers.size
                                _this.newObject3.md5 = headers.md5
                                _this.newObject3.push_mod = _this.pushType
                                _this.newObject3.hashid = headers.hashid
                                _this.uploadinfo3 = headers
