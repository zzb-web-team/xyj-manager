...
<section class="myself-container version_active version_active_new">
    ...
    <div class="devide_table">
        ...
        <el-row type="flex" class="row_active">
            <el-col :span="24">
                <tableBarActive2app id="rebateSetTable2" ref="table2" tooltip-effect="dark" :tableData="tableData1" :clomnSelection="clomnSelection" :rowHeader="rowHeader1" :tableOption="tableOption2" @handleButton="handleButton2" :operatingStatus="operatingStatus" @toOperating="toOperating" @handleSelectionChange="handleSelectionChange" @selectCheckBox="selectCheckBox" @selectAll="selectAll"></tableBarActive2app>
            </el-col>
        </el-row>
    </div>
    ...
    <el-dialog :visible.sync="dialogVisible" width="40%" :before-close="handleClose">
        <el-form ref="form" :model="form" label-width="80px">
            ...
            <el-form-item label="发布版本">
                <el-select v-model="form.versions" placeholder="请选择设备类型">
            ...
            <el-form-item label="      " v-if="allType">
                <el-radio-group v-model="form.assign">
                    <el-radio label="指定账号" style="margin-left:12px;"></el-radio>
            ...
            <el-form-item label="发布时间">
                <el-radio-group v-model="form.time" @change="changeTime">
                    <el-radio label="立即发布" style="margin-left:12px;"></el-radio>
