      ...
      <el-dialog :visible.sync="monitorDetails" class="monitor-details" :close-on-click-modal="false">
        <div class="monitor-con">
          <div class="monitorDetails-top">
            ...
            <table border="1" cellpadding="18" cellspacing="0" width="100%" style="text-align: center;margin: 10px 0;">
              <tr>
          ...
          <div class="monitorDetails-bottom">
            ...
            <el-table :data="tableDataActive" style="width: 100%" :cell-style="rowClass" :header-cell-style="headClass">
              ...
              <el-table-column prop="mb_tem" label="磁盘剩余容量占比">
                <template slot-scope="scope">
                  <span style="color:red;" v-if="scope.row.cap_ratio <= 50">{{ scope.row.cap_ratio + "%" }}
                  </span>
              ...
              <el-table-column prop="mem_ratio" label="内存占比">
                <template slot-scope="scope">
                  <span style="color:red;" v-if="scope.row.mem_ratio >= 80">{{ scope.row.mem_ratio + "%" }}
                  </span>
