        ...
        queryInfo() {
            ...
            if (!this.value2) {
                ...
                if (this.value2 == "") {
                    ...
                    startTime = parseInt((this.value2[0].getTime() / 1000))
                    endTime = parseInt(this.value2[1].getTime() / 1000)
                }
            }
            ...
            ptfs_query_user_trend_list(param).then(res => {
                ...
                if (res.status == 0) {
                    ...
                    for (var i = 0; i < this.tableData.length; i++) {
                        ...
                        this.tableData[i].old_user = this.tableData[i].reg_num + this.tableData[i].old_user_num
                        if ((this.tableData[i].reg_num + this.tableData[i].old_user_num) == 0) {
                            this.tableData[i].percentage = 0 + "%"
                        } else {
                            this.tableData[i].percentage = (((this.tableData[i].reg_num) / (this.tableData[i].reg_num + this.tableData[i].old_user_num)) * 100).toFixed(2) + "%"
                    ...
                    for (var i = 0; i < tempArr.length; i++) {
                        ...
                        this.dataArrX.push(this.common.getTimess(tempArr[i] * 1000))
                        // this.dataArrY.push(tempArr[i].old_user_num)
                    }
