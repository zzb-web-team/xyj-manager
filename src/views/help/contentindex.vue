<template>
	<section class="myself-container">
		...
		<el-dialog
			...
			width="50%"
			:before-close="handleCloseactive"
		...
		>
			<el-form ref="form">
				...
				<div style="text-align: center">
					<el-button @click="dialogVisibleDetail1 = true"
						>预览</el-button
					>
					<el-button type="primary" @click="onSubmitContent"
						>发布</el-button
					>
				</div>
			</el-form>
		...
		>
			<div class="addaccout">
				<div class="title" style="font-weight: bold">
					{{ contentTitleactive }}
					<br />
					<div style="margin-top: 10px; font-weight: 100">
						{{ contentTime }}
					</div>
		...
		<el-dialog
			:visible.sync="dialogVisibleDetail1"
			width="50%"
			:before-close="handleClose"
		>
			<div class="addaccout">
		...
		<el-dialog
			:visible.sync="dialogVisibleDetail2"
			width="50%"
			:before-close="handleClose"
		>
			<div class="addaccout">
		...
		<el-dialog
			:visible.sync="dialogVisiblecontentedit"
			width="50%"
			:before-close="handleClose"
			:close-on-click-modal="false"
		>
			<el-form ref="form">
				...
				<div style="text-align: center">
					<el-button @click="dialogVisibleDetail2 = true"
						>预览</el-button
					>
					<el-button type="primary" @click="onSubmitContentedit"
						>发布</el-button
					>
				</div>
			</el-form>
		...
		<el-dialog
			:visible.sync="dialogVisiblecontentmove"
			width="20%"
			title="移动分组"
		...
		>
			<el-form ref="form">
				...
				<div style="text-align: center">
					<el-button type="primary" @click="onSubmitContentmove"
						>确定</el-button
					>
					<el-button @click="dialogVisiblecontentmove = false"
						>取消</el-button
					>
				</div>
			</el-form>
				...
				this.$confirm('上次编辑的内容未完成，是否继续', '提示', {
					...
					.then(() => {
						...
						if (window.localStorage.getItem('requestid')) {
							tempobj = JSON.parse(
								window.localStorage.getItem('requestid')
							);
						} else {
							tempobj.cat_name = '';
						}
						...
						if (res.data.item_list) {
							...
							for (var i = 0; i < tempArr.length; i++) {
								if (tempArr[i].item_pub_tm == 0) {
									...
									tempArr[
										i
									].item_pub_tm = this.common.getTimes(
								...
								if (tempArr[i].item_change_tm == 0) {
									...
									tempArr[
										i
									].item_change_tm = this.common.getTimes(
