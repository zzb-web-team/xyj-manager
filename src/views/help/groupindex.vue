<template>
	<section class="myself-container">
			...
			<el-form ref="form">
				...
				<div style="text-align: center">
					<el-button type="primary" @click="onSubmitGroup"
						>确定</el-button
					>
					<el-button @click="dialogVisibleGroup = false"
						>取消</el-button
					>
				</div>
			</el-form>
		...
		<el-dialog
			:visible.sync="dialogVisibleGroupEdit"
			width="25%"
			:before-close="handleClose"
		>
			<el-form ref="form">
				...
				<div style="text-align: center">
					<el-button type="primary" @click="onSubmitGroupEdit"
						>确定</el-button
					>
					<el-button @click="dialogVisibleGroupEdit = false"
						>取消</el-button
					>
				</div>
			</el-form>
