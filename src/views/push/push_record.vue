...
<section class="myself-container">
    <el-tabs type="border-card" v-model="activeName" @tab-click="handleClick" style="margin-top:30px;">
                ...
                <el-form ref="form" :model="form" :inline="true" :label-position="labelPosition">
                    <el-row type="flex">
                        <!-- <div class="search-con">
                         ...
                         <el-col :span="4">
          <el-input
  v-model="notice_title" placeholder="请输入标题" @keyup.enter.native="onSubmitKey"
    >
    <i slot="prefix" class="el-input__icon el-icon-search"  @click="onSubmitKey"></i>
              ...
              ></i>
                    ...
                    <el-row type="flex" class="row_activess" v-show="showState">
                        <el-form-item label="状态">
                            <el-select v-model="sendValue" placeholder="请选择" @change="onChange2">
                                <el-option v-for="item in options2" :key="item.value" :label="item.label" :value="item.value">
                                </el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="发送时间">
                            <el-date-picker v-model="times" type="datetimerange" value-format="timestamp" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期"></el-date-picker>
                        </el-form-item>
                    </el-row>
            ...
            <div class="devide_table">
                <el-row type="flex" class="row_active">
                    <el-col :span="24">
                        <tableBarActiveUserPushing id="rebateSetTable" ref="table1" @tableSortChange="tableSortChange" @toDetails="toDetails" @disable="disable" tooltip-effect="dark" :tableData="tableData" :rowHeader="rowHeader" :tableOption="tableOption" @handleButton="handleButton" :operatingStatus="operatingStatus" @toOperating="toOperating"></tableBarActiveUserPushing>
                    </el-col>
                </el-row>
            </div>
  ...
  v-model="notice_title" placeholder="请输入标题" @keyup.enter.native="onSubmitKey"
    ...
    <i slot="prefix" class="el-input__icon el-icon-search"  @click="onSubmitKey"></i>
            ...
            <div class="devide_table">
                <el-row type="flex" class="row_active">
                    <el-col :span="24">
                        <tableBarActiveUserPushing id="rebateSetTable" ref="table1" tooltip-effect="dark" @tableSortChange="tableSortChange1" @toDetails="toDetails1" @disable="disable1" :tableData="tableData" :rowHeader="rowHeader" :tableOption="tableOption" @handleButton="handleButton1" :operatingStatus="operatingStatus" @toOperating="toOperating"></tableBarActiveUserPushing>
                    </el-col>
                </el-row>
            </div>
            <div class="devide_pageNation" style="display: flex;justify-content: flex-end;">
    ...
    <el-dialog :visible.sync="dialogVisible2" width="40%" :before-close="handleClose">
        <p style="width: 100%;text-align: center;">{{this.formInfo1.Notice_title}}</p>
        <p style="width: 100%;text-align: center;">{{this.formInfo1.Notice_push_time}}</p>
        <p style="width: 100%;text-align: center;">{{Notice_contentActive1}}</p>
        <iframe :src="this.htmlUrl" frameborder="0" width="100%" height="100%"></iframe>
    </el-dialog>
</section>
</template>
...
export default {
  ...
  methods: {
            ...
            if (res.data.data) {
              ...
              for (var i = 0; i < tempArr.length; i++) {
                ...
                if (tempArr[i].Notice_audice_type == 1) {
                  ...
                  tempArr[i].Notice_audice_typeActive = "所有人";
                }
                ...
                if (tempArr[i].Notice_modify_time == 0) {
                  tempArr[i].Notice_modify_time = tempArr[i].Notice_push_time;
                }

                tempArr[i].Notice_push_time = this.common.getTimes(
                  tempArr[i].Notice_push_time * 1000
                );
                tempArr[i].Notice_modify_time = this.common.getTimes(
    ...
    toDetails(val) {
      ...
      getnotice(param)
        .then(res => {
          ...
          this.Notice_open_nums_active = res.data.data[0].Notice_open_nums;
          this.Notice_del_nums_active = res.data.data[0].Notice_del_nums;
          this.Notice_reach_nums_active = res.data.data[0].Notice_reach_nums;
        })
        .catch(error => {
          console.log(error);
        });
    ...
    toDetails1(val) {
      ...
      getnotice(param)
        .then(res => {
          this.Notice_contentActive1 = res.data.data[0].Notice_content;
          this.Notice_open_nums_active = res.data.data[0].Notice_open_nums;
          this.Notice_del_nums_active = res.data.data[0].Notice_del_nums;
          this.Notice_reach_nums_active = res.data.data[0].Notice_reach_nums;
        })
