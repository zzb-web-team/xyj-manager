  ...
  <div class="addmarket">
    ...
    >
      ...
      <el-form-item label="一级分类" prop="app_type1" @change="onchangeappType1">
        <!-- <el-select v-model="ruleForm.app_type1" placeholder="请选择应用评分" style="width:300px;">
                ...
                <div class="weui-uploader__bd  plr-15">
                    ...
                    <div class="weui-uploader__input-box">
                     ...
                     <div class="weui-uploader__input-box">
                      ...
                      <div class="weui-uploader__input-box">
                        <input id="fileid3" class="weui-uploader__input" type="file" accept="image/*" @change="addImg4"  ref="inputer4" multiple>
                    </div>
                      <div class="weui-uploader__input-box">
                        <input id="fileid3" class="weui-uploader__input" type="file" accept="image/*" @change="addImg5"  ref="inputer5" multiple>
                    </div>
                    <div>
