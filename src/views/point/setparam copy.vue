    ...
    <div class="device_form">
      <el-form ref="form">
        <el-form-item label>
          ...
          <p>收益公式介绍</p>
         <p>收益P=(P1+P2)/2*R={{B1*V1*(T1/24）+B2*V1*(T2/24）+B3*V1*(T3/24）*45%}*（1+1/4）+F1*V2+F2*V2+F3*V2*45%}/2*R</p>
        <p>P1每日节点理论收益，B1/B2/B3：节点日平均带宽（单位：Mbps）  ，T：日累计在线时长[ T1、T2 电信联通网络在线时长,T3 移动网络在线时长]（单位：小时），V1：日单位带宽的价值（单位：积分）
P2每日节点贡献产生收益，F：节点当日实际贡献的流量（单位：GB），V2：单位流量的价值（单位：积分）</p>
        </el-form-item>
